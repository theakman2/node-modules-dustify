...
module.exports = function(opts, done) {
	if (!opts.src) {
		throw new Error("opts.src must be defined");
	}
	
	if (!opts.build) {
		throw new Error("opts.build must be defined");
	}
	...
	var defaultOutputFileExtension = opts.precompile ? ".js" : ".html";	
	var outputFileExtension = opts.outputExt || defaultOutputFileExtension;
	var templateData = opts.tplData || {};
	var requireBase = opts.requireBase ? path.resolve(opts.requireBase) : null;
	var _fileCache = {};
